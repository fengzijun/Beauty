...
(function(e, t) {
    e.widget("ui.draggable", e.ui.mouse, {
        ...
        _mouseStop: function(t) {
            ...
            return ! i && this.options.helper === "original" ? !1 : (this.options.revert === "invalid" && !s || this.options.revert === "valid" && s || this.options.revert === !0 || e.isFunction(this.options.revert) && this.options.revert.call(this.element, s) ? e(this.helper).animate(this.originalPosition, parseInt(this.options.revertDuration, 10),
            function() {
    ...
    e.ui.plugin.add("draggable", "connectToSortable", {
        ...
        drag: function(t, n) {
            ...
            function() {
                ...
                this.instance._intersectsWith(this.instance.containerCache) && (s = !0, e.each(r.sortables,
                function() {
    ...
    e.ui.plugin.add("draggable", "snap", {
        ...
        drag: function(t, n) {
            ...
            for (c = p.snapElements.length - 1; c >= 0; c--) {
                ...
                h = r || i || s || o,
                d.snapMode !== "outer" && (r = Math.abs(f - y) <= v, i = Math.abs(l - b) <= v, s = Math.abs(u - m) <= v, o = Math.abs(a - g) <= v, r && (n.position.top = p._convertPositionTo("relative", {
                    top: f,
                    left: 0
                }).top - p.margins.top), i && (n.position.top = p._convertPositionTo("relative", {
    ...
    e.ui.ddmanager = {
        ...
        drop: function(t, n) {
            ...
            function() {
                ...
                !this.options.disabled && this.visible && this.accept.call(this.element[0], t.currentItem || t.element) && (this.isout = !0, this.isover = !1, this._deactivate.call(this, n))
            }),
            r
        },
        ...
        drag: function(t, n) {
            ...
            function() {
                ...
                r && u === "isover" && (r.isover = !1, r.isout = !0, r._out.call(r, n)),
                this[u] = !0,
...
(function(e, t) {
    ...
    e.widget("ui.resizable", e.ui.mouse, {
        ...
        _create: function() {
            ...
            if (this.handles.constructor === String) {
                ...
                this.handles = {};
                for (n = 0; n < t.length; n++) r = e.trim(t[n]),
                s = "ui-resizable-" + r,
            ...
            this._renderAxis = function(t) {
                ...
                for (n in this.handles) {
                    ...
                    this.elementIsWrapper && this.originalElement[0].nodeName.match(/textarea|input|select|button/i) && (r = e(this.handles[n], this.element), s = /sw|ne|nw|se|n|s/.test(n) ? r.outerHeight() : r.outerWidth(), i = ["padding", /ne|nw|n/.test(n) ? "Top": /se|sw|s/.test(n) ? "Bottom": /^e$/.test(n) ? "Right": "Left"].join(""), t.css(i, s), this._proportionallyResize());
        ...
        _updateVirtualBoundaries: function(e) {
            ...
            if (this._aspectRatio || e) t = o.minHeight * this.aspectRatio,
        ...
        _updateRatio: function(e) {
            ...
            i === "nw" && (e.top = t.top + (n.height - e.height), e.left = t.left + (n.width - e.width)),
            e
        },
    ...
    e.ui.plugin.add("resizable", "alsoResize", {
        start: function() {
            ...
            typeof n.alsoResize == "object" && !n.alsoResize.parentNode ? n.alsoResize.length ? (n.alsoResize = n.alsoResize[0], r(n.alsoResize)) : e.each(n.alsoResize,
            function(e) {
                r(e)
            }) : r(n.alsoResize)
        },
    ...
    e.widget("ui.selectable", e.ui.mouse, {
        ...
        _mouseDrag: function(t) {
            ...
            this.selectees.each(function() {
                ...
                f ? (n.selected && (n.$element.removeClass("ui-selected"), n.selected = !1), n.unselecting && (n.$element.removeClass("ui-unselecting"), n.unselecting = !1), n.selecting || (n.$element.addClass("ui-selecting"), n.selecting = !0, r._trigger("selecting", t, {
                    selecting: n.element
    ...
    e.widget("ui.sortable", e.ui.mouse, {
        ...
        _mouseCapture: function(t, n) {
            ...
            e(t.target).parents().each(function() {
                if (e.data(this, s.widgetName + "-item") === s) return r = e(this),
                !1
            }),
        ...
        _getItemsAsjQuery: function(t) {
            ...
            if (a && t) for (n = a.length - 1; n >= 0; n--) {
                i = e(a[n]);
                for (r = i.length - 1; r >= 0; r--) s = e.data(i[r], this.widgetFullName),
        ...
        _refreshItems: function(t) {
            ...
            for (n = c.length - 1; n >= 0; n--) {
                o = c[n][1],
                u = c[n][0];
                for (r = 0, f = u.length; r < f; r++) a = e(u[r]),
        ...
        _createPlaceholder: function(t) {
            t = t || this;
            var n, r = t.options;
            if (!r.placeholder || r.placeholder.constructor === String) n = r.placeholder,
            r.placeholder = {
                element: function() {
        ...
        _contactContainers: function(t) {
            ...
            this.containers[h].containerCache.over = 1;
                ...
                for (r = this.items.length - 1; r >= 0; r--) {
                    ...
                    l = !1,
                    Math.abs(f - a) > Math.abs(f + this.items[r][u] - a) && (l = !0, f += this.items[r][u]),
                    Math.abs(f - a) < i && (i = Math.abs(f - a), s = this.items[r], this.direction = l ? "up": "down")
                }
        ...
        _clear: function(t, n) {
            this.reverting = !1;
            var r, i = []; ! this._noFinalSort && this.currentItem.parent().length && this.placeholder.before(this.currentItem),
        ...
        _create: function() {
            ...
            this._on(this.menu.element, {
                ...
                menufocus: function(t, n) {
                    ...
                    var r = n.item.data("ui-autocomplete-item"); ! 1 !== this._trigger("focus", t, {
                        item: r
...
(function(e, t) {
    ...
    e.extend(s.prototype, {
        ...
        _attachments: function(t, n) {
            ...
            if (r === "button" || r === "both") i = this._get(n, "buttonText"),
        ...
        _destroyDatepicker: function(t) {
            ...
            r = t.nodeName.toLowerCase(),
            e.removeData(t, n),
            r === "input" ? (s.append.remove(), s.trigger.remove(), i.removeClass(this.markerClassName).unbind("focus", this._showDatepicker).unbind("keydown", this._doKeyDown).unbind("keypress", this._doKeyPress).unbind("keyup", this._doKeyUp)) : (r === "div" || r === "span") && i.removeClass(this.markerClassName).empty()
        },
        ...
        _optionDatepicker: function(n, r, i) {
            ...
            if (arguments.length === 2 && typeof r == "string") return r === "defaults" ? e.extend({},
            e.datepicker._defaults) : l ? r === "all" ? e.extend({},
            l.settings) : this._get(l, r) : null;
            s = r || {},
            typeof r == "string" && (s = {},
            s[r] = i),
            l && (this._curInst === l && this._hideDatepicker(), o = this._getDateDatepicker(n, !0), a = this._getMinMaxDate(l, "min"), f = this._getMinMaxDate(l, "max"), u(l.settings, s), a !== null && s.dateFormat !== t && s.minDate === t && (l.settings.minDate = this._formatDate(l, a)), f !== null && s.dateFormat !== t && s.maxDate === t && (l.settings.maxDate = this._formatDate(l, f)), "disabled" in s && (s.disabled ? this._disableDatepicker(n) : this._enableDatepicker(n)), this._attachments(e(n), l), this._autoSize(l), this._setDate(l, o), this._updateAlternate(l), this._updateDatepicker(l))
        },
        ...
        _selectDate: function(t, n) {
            ...
            s.inline ? this._updateDatepicker(s) : (this._hideDatepicker(), this._lastInput = s.input[0], typeof s.input[0] != "object" && s.input.focus(), this._lastInput = null)
        },
        ...
        parseDate: function(t, n, r) {
            ...
            S = function(t, r, i) {
                ...
                function(e, t) {
                    var r = t[1];
                    if (n.substr(u, r.length).toLowerCase() === r.toLowerCase()) return s = t[0],
                    u += r.length,
                    !1
                });
                if (s !== -1) return s + 1;
        ...
        _generateHTML: function(e) {
            ...
            if (Y) {
                ...
                t = G && t < G ? G: t;
                while (this._daylightSavingAdjust(new Date(et, Z, 1)) > t) Z--,
                Z < 0 && (Z = 11, et--)
            }
            e.drawMonth = Z,
            e.drawYear = et,
                ...
                for (T = 0; T < V[1]; T++) {
                    ...
                    if (K) {
                        ...
                        case 0:
                            ...
                            break;
                        case V[1] - 1 : k += " ui-datepicker-group-last",
...
(function(e, t) {
    ...
    e.widget("ui.dialog", {
        ...
        options: {
            ...
            buttons: [],
            closeOnEscape: !0,
            closeText: "<img src='/images/close.png' style='margin-top:-30px'>",
            dialogClass: "",
            draggable: !0,
            hide: null,
            height: "auto",
        ...
        _createTitlebar: function() {
            ...
            this.uiDialogTitlebarClose = e("<button></button>").button({
                ...
                label: this.options.closeText, icons: { primary: "ui-icon-closethick" }, text: !1
...
(function(e, t) {
    ...
    e.widget("ui.slider", e.ui.mouse, {
        ...
        _create: function() {
            ...
            this.range = e([]),
            r.range && (r.range === !0 && (r.values ? r.values.length && r.values.length !== 2 ? r.values = [r.values[0], r.values[0]] : e.isArray(r.values) && (r.values = r.values.slice(0)) : r.values = [this._valueMin(), this._valueMin()]), this.range = e("<div></div>").appendTo(this.element).addClass("ui-slider-range ui-widget-header" + (r.range === "min" || r.range === "max" ? " ui-slider-range-" + r.range: ""))),
...
(function(e) {
    ...
    e.widget("ui.spinner", {
        ...
        _setOption: function(e, t) {
            ...
            e === "icons" && (this.buttons.first().find(".ui-icon").removeClass(this.options.icons.up).addClass(t.up), this.buttons.last().find(".ui-icon").removeClass(this.options.icons.down).addClass(t.down)),
            this._super(e, t),
        ...
        _initialActive: function() {
            ...
            if (t === null) {
                r && this.tabs.each(function(n, i) {
                    if (e(i).attr("aria-controls") === r) return t = n,
                    !1
                }),
